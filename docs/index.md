...
- **[CLI Reference](api/cli.md)**: Explore the command-line interface for regression testing, arena benchmarks, doctor diagnostics, and database pruning.
- **[Python SDK Reference](api/sdk.md)**: Integrate promptdiff directly into Python pipelines and pytest test suites.
