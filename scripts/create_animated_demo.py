...
def create_demo_gif() -> None:
    ...
    if demo_png.exists():
        ...
        draw.text(
            (30, 80),
            "$ promptdiff run prompts/system_v1.txt prompts/system_v2.txt --inputs testcases.jsonl --forecast 1M",
            fill=(56, 189, 248, 255),
            font=font_code,
        )
        ...
        draw2.text(
            (30, 130), "⚡ Running regression test on 3 test cases...", fill=(203, 213, 225, 255), font=font_code
        )
