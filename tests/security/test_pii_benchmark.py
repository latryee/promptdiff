...
PII_BENCHMARK_CORPUS: list[dict[str, Any]] = [
    ...
    {
        "text": "Exported secret sk-abc1234567890defghijklmnop to production environment.",
        "has_pii": True,
        "type": "API_KEY",
    },
    {
        "text": "GitHub personal access token: ghp_1234567890abcdefghijklmnopqrstuvwxyz.",
        "has_pii": True,
        "type": "API_KEY",
    },
    {
        "text": "AWS root access key ID AKIAIOSFODNN7EXAMPLE detected in config file.",
        "has_pii": True,
        "type": "API_KEY",
    },
    {
    ...
    {
        "text": "IPv6 loopback configured as ::1 or 2001:0db8:85a3:0000:0000:8a2e:0370:7334.",
        "has_pii": False,
        "type": "IPV6",
    },
    {
        "text": "Transaction session UUID 123e4567-e89b-12d3-a456-426614174000 created.",
        "has_pii": False,
        "type": "UUID",
    },
    {
        "text": "Git commit SHA 4b65fb7cdf694586deb2817f0612e5c7068cbbb1 merged to main.",
        "has_pii": False,
        "type": "GIT_HASH",
    },
    {"text": "Product order SKU ORD-99283-X1 with discount code SAVE20.", "has_pii": False, "type": "SKU"},
    {
        "text": "Style guide background color hex code #FFFFFF with border #334455.",
        "has_pii": False,
        "type": "HEX_COLOR",
    },
    {"text": "Calculated model token latency: 120ms with 4096 context tokens.", "has_pii": False, "type": "METRICS"},
    {
        "text": "Markdown table row: | Customer_ID | Status | Tier | 100 | Active | Gold |",
        "has_pii": False,
        "type": "TABLE",
    },
    {"text": "Mathematical formula: f(x) = 2x^2 + 5x - 10 where x in [0, 100].", "has_pii": False, "type": "MATH"},
    {
        "text": "Invalid credit card test numbers 1234 5678 9012 3456 rejected by Luhn.",
        "has_pii": False,
        "type": "INVALID_CARD",
    },
    {"text": "Documentation URL: https://docs.promptdiff.dev/guide/quickstart.html", "has_pii": False, "type": "URL"},
    {
        "text": "Standard error code ERR_CONNECTION_TIMED_OUT occurred in worker-4.",
        "has_pii": False,
        "type": "ERROR_CODE",
    },
]
